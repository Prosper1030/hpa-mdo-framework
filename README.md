...
| **hpa-meshing** | Geometry normalization → gmsh → SU2, with artifact contracts and convergence gates. The paused productization line — not the source of the verification results above. | **Paused experimental** | **Publication pending.** A cleaned public release is being prepared separately. |
